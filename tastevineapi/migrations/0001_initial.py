# Generated by Django 4.2.8 on 2023-12-06 21:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_ingredient', to='tastevineapi.ingredient')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_ingredient', to='tastevineapi.recipe')),
            ],
        ),
        migrations.CreateModel(
            name='RecipeCategory',
